                            ...
                            <div class="iq-card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="contact" class="form-control" placeholder="Enter Company Contact" value="{{ $company->contact }}">
                                        <div style="color: #ff0000; font-size: x-small; margin-top: 3px;">{{ $errors->first('contact') }}</div>
                                    </div>
                                </div>
