                            ...
                            <div class="iq-card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="purchase_price" class="form-control" placeholder="Enter Purchase Price" value="{{ old('purchase_price') }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="company_price" class="form-control" placeholder="Enter Company Price" value="{{ old('company_price') }}">
