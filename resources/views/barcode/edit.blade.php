                            ...
                            <div class="iq-card-body">
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="item_code" class="form-control" placeholder="Enter Item Code" value="{{ $item->item_code }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select name="sub_category_id" class="form-control">
                                            @foreach($subCategories as $subCategory)
                                                <option value="{{ $subCategory->id }}"{{ $item->sub_category_id == $subCategory->id ? 'selected' : ''}}>{{ $subCategory->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="sale_price_1" class="form-control" placeholder="Enter Sale Price 1" value="{{ $item->sale_price_1 }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="sale_price_2" class="form-control" placeholder="Enter Sale Price 2" value="{{ $item->sale_price_2 }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="sale_price_3" class="form-control" placeholder="Enter Sale Price 3" value="{{ $item->sale_price_3 }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="sale_price_4" class="form-control" placeholder="Enter Sale Price 4" value="{{ $item->sale_price_4 }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="sale_price_5" class="form-control" placeholder="Enter Sale Price 5" value="{{ $item->sale_price_5 }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="remarks" class="form-control" placeholder="Enter Remarks" value="{{ $item->remarks }}">
