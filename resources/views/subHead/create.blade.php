                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <form method="post" action="{{route('subHead.store')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial_code" class="form-control" placeholder="Enter Serial Code" value="{{ sprintf('%02d', $serial_code) }}" readonly>
