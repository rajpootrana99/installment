                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <form method="post" action="{{route('vendor.update', ['vendor' => $vendor])}}" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                <div class="row">
                                    <div class="form-group col-6 text-center">
                                        <div class="add-img-user profile-img-edit">
                                            <img id="output_image" class="profile-pic" width="150px" height="150px" src="{{ asset('storage/'.$vendor->image) }}" alt="profile-pic">
                                            <div class="p-image">
                                    ...
                                    <div class="form-group col-6">
                                        <div>
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Enter Name" value="{{ $vendor->name }}">
                                            <div style="color: #ff0000; font-size: x-small; margin-top: 3px;">{{ $errors->first('name') }}</div>
                                        </div>
                                        <div class="mt-4">
                                            <label for="father_name">Father Name:</label>
                                            <input type="text" name="father_name" class="form-control" placeholder="Enter Father Name" value="{{ $vendor->father_name }}">
                                            <div style="color: #ff0000; font-size: x-small; margin-top: 3px;">{{ $errors->first('father_name') }}</div>
                                        </div>
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="cell">Cell:</label>
                                        <input type="text" name="cell" class="form-control" placeholder="Enter Cell Number" value="{{ $vendor->cell }}">
                                        <div style="color: #ff0000; font-size: x-small; margin-top: 3px;">{{ $errors->first('cell') }}</div>
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="cnic">CNIC:</label>
                                        <input type="text" name="cnic" class="form-control" placeholder="Enter CNIC" value="{{ $vendor->cnic }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control" name="material_status">
                                            @foreach($vendor->materialStatusOptions() as $materialStatusOptionsKey => $materialStatusOptionssValue)
                                                <option value="{{ $materialStatusOptionsKey }}"{{ $vendor->material_status = $materialStatusOptionsKey ? 'selected' : '' }}>{{ $materialStatusOptionssValue }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="residential_address" class="form-control" placeholder="Enter Residential Address" value="{{ $vendor->residential_address }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="residential_phone" class="form-control" placeholder="Enter Residential Phone" value="{{ $vendor->residential_phone }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="date" name="residential_since" class="form-control" placeholder="Enter Residential Since" value="{{ $vendor->residential_since }}">
                                        <div style="color: #ff0000; font-size: x-small; margin-top: 3px;">{{ $errors->first('residential_since') }}</div>
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="office_address">Office Address:</label>
                                        <input type="text" name="office_address" class="form-control" placeholder="Enter Office Address" value="{{ $vendor->office_address }}">
                                        <div style="color: #ff0000; font-size: x-small; margin-top: 3px;">{{ $errors->first('office_address') }}</div>
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="office_phone">Office Phone:</label>
                                        <input type="text" name="office_phone" class="form-control" placeholder="Enter Office Phone" value="{{ $vendor->office_phone }}">
