                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <form method="post" action="{{route('head.update', ['head' => $head])}}" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                <div class="form-group">
                                    <label for="name">Name:</label>
                                    <input type="text" name="name" class="form-control" placeholder="Name" value="{{ $head->name }}">
                                    <div style="color: #ff0000; font-size: x-small; margin-top: 3px;">{{ $errors->first('name') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="serial_code">Serial Code:</label>
                                    <input type="text" name="serial_code" class="form-control" placeholder="Enter Serial Code" value="{{ $head->serial_code }}">
